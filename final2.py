...
# Main loop to control both motors with keyboard input and capture images
try:
    print("Controls:")
    print("Servo Controls: Q - Turn Left, E - Turn Right, R - Center")
    print("DC Motor Controls: I - Forward, K - Backward, + - Increase Speed, - - Decrease Speed, X - Stop Motor")
    print("Press 's' to capture an image, 'c' to quit")
    ...
    # Path to save images on Desktop
    desktop_path = '/home/pi/Desktop'  # Raspberry Pi desktop path
    ...
    while True:
        ...
        # Capture an image when 's' key is pressed
            ...
            # Save the image in the Desktop directory with a timestamp
